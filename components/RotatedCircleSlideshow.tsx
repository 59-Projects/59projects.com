 ...
 *
 * The homepage's project list is unlisted in production (see
 * `isProjectsSectionUnlisted`), so this component's box, which stretches
 * behind that list to reach the footer, is effectively just the hero image
 * there with nothing painted on top of it. A bottom-anchored dots row is
 * only at risk of being covered when previewing with projects temporarily
 * un-hidden locally; not worth the complexity of dynamically measuring the
 * hero row's height to dodge that local-only edge case.
 */
